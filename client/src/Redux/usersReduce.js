...
export const exportExcel = createAsyncThunk("planning/exportExcelTerritory", async (action) => {
  var annee = action.annee;
  const response = await fetch(Configuration.BACK_BASEURL + `user/exportExcelTerritory/${annee}`, {
    method: 'GET',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
...
export const getActivePere = createAsyncThunk("user/getActivePere", async () => {
  const response = await fetch(Configuration.BACK_BASEURL + "user/getActivePere", {
    method: 'GET',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
...
export const userChangeEtat = createAsyncThunk("user/changeEtat", async (id) => {
...
export const changePassword = createAsyncThunk(
  ...
  async (action) => {
    const response = await fetch(
      Configuration.BACK_BASEURL + "user/changePassword",
      {
        method: "PUT",
        headers: {
          Accept: "application/json",
...
export const verifEmail = createAsyncThunk("user/allUserForTestMail", async (action) => {
  const response = await fetch(Configuration.BACK_BASEURL + "user/allUserForTestMail", {
    method: 'POST',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
