...
export const rootBaseDeleted = createAsyncThunk("root/deleteRoot", async (action) => {
  const response = await fetch(Configuration.BACK_BASEURL + "root/deleteRoot/"+action.id, {
    method: 'DELETE',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
